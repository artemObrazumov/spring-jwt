...
import com.artemObrazumov.jwt_implementation.token.dto.Tokens;
import com.artemObrazumov.jwt_implementation.token.factory.AccessTokenFactory;
...
public class RequestAccessTokenFilter extends OncePerRequestFilter {

    private RequestMatcher requestMatcher = new AntPathRequestMatcher("/jwt/accessToken", HttpMethod.POST.name());
        ...
        if (requestMatcher.matches(request)) {
            if (this.securityContextRepository.containsContext(request)) {
                ...
                if (context != null && context.getAuthentication() instanceof PreAuthenticatedAuthenticationToken &&
                    ...
                    var tokens = new Tokens(this.accessTokenStringSerializer.apply(accessToken),
